...
<KeyFactsTable
  className="my-8"
  extraFacts={[{ label: "Business / startup proceeds", value: "Sale proceeds are not themselves an anticipated qualifying path. A share sale, asset sale, or startup exit can produce the capital that later funds a qualifying Argentine investment. It does not, by itself, create citizenship. Real estate, business or startup ventures, and investment funds are not anticipated qualifying paths." }]}
/>
