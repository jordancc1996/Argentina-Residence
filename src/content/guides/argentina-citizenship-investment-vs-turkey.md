...
That is the structural point versus residency-track European golden visas, and it is also the point of contact with Argentina. Decree 524/2025 and Decree 366/2025 describe Argentine citizenship through a relevant, productive investment, without a prior two-year ordinary residence period. See [residency requirements](/faq/argentina-residency-physical-presence). Both programs, on paper, aim at nationality. Only one of them is taking files.
