...
- Processing. Caribbean units measure time in months from a complete submission. This site states a 30-business-day Argentine decision window after certification. That Argentine clock does not run until APCI is processing files. See [application process timeline](/faq/argentina-citizenship-investment-application-timeline).
