    ...
    <p className="not-prose my-8">
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          ...
          >
            Compare Your Investment Migration Options
          </button>
        </DialogTrigger>
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm text-text-secondary tracking-wide leading-relaxed">
              Counsel on Argentine and Panamanian investment routes can be arranged through this office.
            </DialogDescription>
          </DialogHeader>
...
export default CompareOptionsCta;
